  ...
  <nav>
    <div class="container">
      ...
      <div class="nav-sub-wrapper">
        <div class="nav-sub">
          <div class="serchbar">
            <searchbar @find-goods-by-name="findGoodsByname" />
          </div>
          <div class="publish">
            <el-dropdown @command="handleCommand">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item command="/releaseGoods"
                  >发布</el-dropdown-item
                >
                <el-dropdown-item command="/releaseWanted"
                  >求购</el-dropdown-item
                >
              </el-dropdown-menu>
            </el-dropdown>
          ...
          <div class="avatar" v-if="this.$store.state.isLogin">
            ...
            ></el-avatar>
            <el-dropdown @command="handleCommand">
              <span class="username" @click="handlePersonal">{{
              ...
              <el-dropdown-menu slot="dropdown" style="width:150px">
                ...
                <el-dropdown-item command="/myWanteds"
                  >我的求购</el-dropdown-item
                >
                <el-dropdown-item command="/myOrder">我的订单</el-dropdown-item>
                <el-dropdown-item command="/myNotice"
          ...
          <div class="login" v-if="this.$store.state.isLogin === false">
            <el-link type="primary" :underline="false" @click="jumpToLogin"
              >登录</el-link
            >
            |
            <el-link type="primary" :underline="false" @click="jumpToRegister"
              >注册</el-link
            >
          </div>
          <div class="logout" v-else>
            <div class="cart" @click="handleToMyCary">
              <el-badge
                :value="
                  this.$store.state.myCart === null
                    ? 0
                    : this.$store.state.myCart.length
                "
                type="success"
                class="item"
              >
