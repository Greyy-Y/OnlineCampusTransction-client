				...
				<div class="reciver-box">
					...
					<div class="address-box-wrapper">
						...
						>
							...
							<div class="operate">
								<el-button icon="el-icon-edit" circle size="mini" @click="editAdd(index)"></el-button>
								<el-button icon="el-icon-delete" circle size="mini" @click="deleteAdd(item._id)"></el-button>
							</div>
						</div>
					...
					>
						<el-form>
							<el-form-item label="收货人" :label-width="formLabelWidth">
								<el-input v-model="editAddress.receiver" autocomplete="off"></el-input>
							</el-form-item>
							<el-form-item label="收货地址" :label-width="formLabelWidth">
								<el-input v-model="editAddress.detailAdd" autocomplete="off"></el-input>
							</el-form-item>
							<el-form-item label="电话号码" :label-width="formLabelWidth">
								<el-input v-model="editAddress.phone" autocomplete="off"></el-input>
							</el-form-item>
						</el-form>
					...
					<el-dialog title="收货地址" :visible.sync="dialogFormVisible" width="500px">
						<el-form :model="newAddr">
							<el-form-item label="收货人" :label-width="formLabelWidth">
								<el-input v-model="newAddr.receiver" autocomplete="off"></el-input>
							</el-form-item>
							<el-form-item label="收货地址" :label-width="formLabelWidth">
								<el-input v-model="newAddr.detailAdd" autocomplete="off"></el-input>
							</el-form-item>
							<el-form-item label="电话号码" :label-width="formLabelWidth">
...
<script>
	import { GetAddress, AddAddress, DeleteAddress, UpdateAddress } from "@/api/user";
		...
		methods: {
			...
			async createOrder() {
				...
				if (res.status === 200) {
					...
					this.$router.push({ name: "ToPay", params: { oid: res.data.order._id } });
					this.getAddress();
				} else {
					this.$message({
						type: "warning",
