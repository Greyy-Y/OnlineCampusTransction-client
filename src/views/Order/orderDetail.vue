            ...
            <div class="progress">
              ...
              <div class="desc">
                <div class="readyToPay" v-if="order.state + 1 === 1">
                  <h3>订单状态：未支付</h3>
                  <el-button style="margin-left:20px" @click="toPay"
                    >去支付</el-button
                  >
                </div>

                <h3 v-if="order.state + 1 === 2">
                  订单状态：已支付，请等待商家发货
                </h3>
                <div class="receiveGoods" v-if="order.state + 1 === 3">
                  <h3>订单状态：已发货，请耐心等待</h3>
                  <el-button style="margin-left:70px" @click="ackGood"
                    >确认收货</el-button
                  >
                </div>
              </div>
