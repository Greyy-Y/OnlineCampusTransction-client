        ...
        <div class="comment-box">
          ...
          >
            ...
            <div class="content-box">
              <div class="rate">
                <el-rate v-model="item.rate" :disabled="disabled"> </el-rate>
              </div>
  ...
  methods: {
    ...
    async addToCart() {
      ...
      if (res.status === 200) {
        ...
        //更新vuex购物车
        this.$store.commit("setMyCart", { cart: res.data.cart.cart });
    ...
    async getGoodsByID() {
      ...
      this.good.createdAt = this.dayjs(this.good.createdAt).format(
        "YYYY-MM-DD"
      );
