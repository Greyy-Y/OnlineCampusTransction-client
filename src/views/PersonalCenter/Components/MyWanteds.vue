<template>
  <div class="mywanteds-wrapper">
    ...
    <div
      class="mywanted-box"
      v-for="(item, index) in newMyWanteds"
      :key="index"
      v-else
    >
      ...
      <div class="mywanted-info">
        ...
        <div class="mywanted-button">
          <div class="status">
            ...
            <el-button v-else-if="item.state === 0" type="primary" size="mini"
              >未通过</el-button
            >
            <el-button v-if="item.state === 2" type="success" size="mini"
              >已通过</el-button
            >
          </div>
          <el-button type="danger" size="mini" @click="handleDelete(item._id)"
            >删除</el-button
          >
        </div>
      </div>
