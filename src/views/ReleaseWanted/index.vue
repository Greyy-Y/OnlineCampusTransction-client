			...
			<div class="form">
				<el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm" label-width="60px">
					...
					<el-form-item label="标题" prop="name">
						<el-input v-model="ruleForm.name" placeholder="很重要，让您的需求一目了然"></el-input>
					</el-form-item>
					...
					<el-form-item label="预算" prop="budget">
						<el-input v-model="ruleForm.budget" placeholder="能接受的价格"></el-input>
					</el-form-item>
					<el-form-item label="微信" prop="contact">
						<el-input v-model="ruleForm.contact" placeholder="联系方式（微信，QQ，手机）"></el-input>
					</el-form-item>
	...
	export default {
		...
		data() {
			return {
				...
				rules: {
					name: [{ required: true, message: "请输入求购商品名称", trigger: "blur" }],
