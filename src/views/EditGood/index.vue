			...
			<div class="form">
				<el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm" label-width="60px">
					...
					<el-form-item style="display:flex">
						<div>请选择 1 张图片上传，推荐750*750px，小于2M (新上传的图片将替换旧的图片)</div>
					</el-form-item>
					<el-form-item style="display:flex" v-model="ruleForm.pic" prop="pic" label="图片" id="picArea">
						...
						<el-col :span="10">
							<div class=""><img :src="baseUrl + this.oldPic" v-if="ruleForm.pic.length != 0" id="oldPic" /></div
						></el-col>
					</el-form-item>
		...
		data() {
			...
			return {
				...
				rules: {
					...
					originPrice: [{ required: true, validator: validatePrice, trigger: "blur" }],
					new: [
